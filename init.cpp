...
Init::pipelineShaderStageCreateInfo(VkShaderStageFlagBits stage, VkShaderModule shaderModule) {
...
VkPipelineInputAssemblyStateCreateInfo Init::inputAssemblyStateCreateInfo(VkPrimitiveTopology topology) {
...
VkPipelineMultisampleStateCreateInfo Init::multisampleStateCreateInfo() {
...
VkPipelineDepthStencilStateCreateInfo Init::depthStencilStateCreateInfo(bool depthTest, bool depthWrite, VkCompareOp compareOp) {
